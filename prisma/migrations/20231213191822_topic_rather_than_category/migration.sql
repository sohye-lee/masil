/*
  ...
  - Added the required column `topicId` to the `Snippet` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Snippet" (
    ...
    CONSTRAINT "Snippet_topicId_fkey" FOREIGN KEY ("topicId") REFERENCES "Topic" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
